        ...
        <>
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto  sm:pr-0">
                <div className='hidden lg:block'>
                    <button className="text-dodgerblue text-xl font-medium ml-9 py-6 px-12 transition duration-150 ease-in-out bg-white hover:text-white rounded-full hover:bg-dodgerblue ttty" onClick={openModal} hidden>
                        {/* Sign up */}
                    </button>
                </div>
            </div>
