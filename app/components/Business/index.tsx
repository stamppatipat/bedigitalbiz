        ...
        <div className="mx-auto max-w-7xl pt-20 sm:pb-24 px-6">
            ...
            <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1'>
                ...
                <div className='col-span-6 flex flex-col justify-center'>
                    ...
                    <h3 className='text-black text-lg font-normal text-center lg:text-start lh-173 opacity-75 pt-3'>การเชื่อมต่อที่เชื่อถือได้และปลอดภัยสามารถเข้าถึงได้ไม่ว่าคุณจะอยู่ที่ไหน วางใจในเทคโนโลยี Meraki ในสํานักงาน ที่บ้าน หรือออกนอกบ้านบนถนนเปิด</h3>
